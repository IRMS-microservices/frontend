  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <p className="text-gray-500 text-sm mb-8 leading-relaxed">
        Let's set up the digital foundation for your dining experience. We've
        pre-filled some details based on your location.
      </p>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        <div>
          ...
          <input
            ...
            className="w-full bg-white border border-gray-200 shadow-sm rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-irms-green focus:outline-none"
          />
        </div>
        ...
        <div className="bg-[#F8F9FA] rounded-xl p-5 mt-2">
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <label className="text-[10px] font-bold text-gray-500 tracking-widest uppercase mb-1.5 block">
                Currency
              </label>
              <div className="bg-gray-200/50 rounded text-sm px-3 py-2 text-gray-600 font-medium">
                VND (₫)
              </div>
            </div>
            <div className="flex-1">
        ...
        <div className="flex justify-between items-center mt-6">
          <button
            type="button"
            onClick={onBack}
            className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold py-2.5 px-6 rounded-lg transition-colors text-sm"
          >
            Back
          </button>
          <button
            type="submit"
            className="bg-[#0D402E] cursor-pointer hover:opacity-90 transition-opacity duration-300 text-white font-bold py-2.5 px-6 rounded-lg shadow-md flex items-center gap-2 text-sm"
          >
            CONTINUE
            <svg
              width="16"
